...
function noPose(state, count) {
  return { state, count, elbowAngle: null, bodyAligned: null, legsStr: null, stateChanged: false };
}
...
export function createPushupCounter() {
  ...
  function update(keypoints, bodyAlignmentGate = true) {
    ...
    if (bodyAligned === false) {
      return { state, count, elbowAngle: Math.round(elbowAngle), bodyAligned: false, legsStr: null, stateChanged: false };
    }
    ...
    if (legsStr === false) {
      return { state, count, elbowAngle: Math.round(elbowAngle), bodyAligned, legsStr: false, stateChanged: false };
    }
